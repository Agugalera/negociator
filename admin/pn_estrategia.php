...
?><?php 
	...
	if (isset($_POST['submit'])) {
		...
		$query = "UPDATE dataEstrategia SET puntaje = {$_POST['puntaje']} WHERE usuario = '{$_POST['equipo']}'";
      ...
      <div>
        ...
        <!--id="left-column"-->
					...
					if ($_GET['equipo']) {
						...
						$row = get_single_value ('dataEstrategia', 'usuario', $_GET['equipo']);
						...
						if (mysql_num_rows($row)>0) {
							...
							echo "<p>".$row['estrategia']."</p>";

							echo "<p class='botonera'>"?>

							<form method="post" action="pn_estrategia.php?equipo=<?php echo $_GET['equipo'];?>">
